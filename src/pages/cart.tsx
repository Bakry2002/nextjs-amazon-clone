        ...
        <div className='max-w-screen-2xl mx-auto px-6 grid grid-cols-5 gap-10 py-4'>
            {
                productData.length > 0 ? (
                    <>
                        <div className='bg-white col-span-4 p-4 rounded-lg'>
                            <div className='flex items-center justify-between border-b-[1px] border-gray-400 pb-1'>
                                ...
                                <p className="text-lg font-medium text-amazon_blue">Subtitle</p>
                            </div>
                            <div className='pt-2 flex flex-col gap-2'>
                                {
                                    productData.map((product: StoreProps) => (
                                        <div key={product._id}>
                    ...
                    <div className='bg-white h-64 col-span-5 flex flex-col items-center justify-center py-5 rounded-lg shadow-lg'>
                        ...
                        <Link href='/'>
                            <button className='w-52 h-10 bg-amazon_blue text-white rounded-lg text-sm font-medium hover:bg-amazon_yellow hover:text-black duration-300'>Go to shopping</button>
                        </Link>
                    </div>
                )
            }
